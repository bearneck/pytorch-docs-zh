...
欢迎使用 **PyTorch 官方文档中文版**！本站由 [DeepSeek AI](https://deepseek.com) 自动翻译自 [PyTorch 官方英文文档](https://pytorch.org/docs/)。

## 🚀 快速开始

| 分类 | 说明 |
|------|------|
| [核心 API](source/pytorch-api.md) | torch、Tensor、autograd、nn 等核心模块 |
| [数学计算](source/fft.md) | FFT、线性代数、概率分布等 |
